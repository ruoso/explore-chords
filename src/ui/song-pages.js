 ...
 */
export function renderSongPages(container, { store, sheet, instrument, variation, startAt = 0 }) {
  clear(container);
  ...
  const article = renderSheetPrint(stage, {
    store,
    sheet,
    instrument,
    variation,
  ...
  watchResize(container, { store, sheet, instrument, variation }, geometry, sheets);
